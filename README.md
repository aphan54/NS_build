...
3. **Zoning (Ku-ring-gai Council)**:
   ...
   - **FSR**: 0.6:1 in R3; 1,100 m² × 0.6 = 660 m² max GFA. 600 m² fits, no variation needed.
...
4. **Site Constraints**:
   - **Topography/Slope**: Waterfront reserve backdrop suggests slope to Middle Harbour. Assess gradient; >15% may need retaining walls.
   - **Soil Type/Stability**: Test for clay/sandstone; waterfront may indicate softer soils.
   - **Tree Preservation**: 50% canopy cover required; bushland likely has protected trees.
   - **Flood Risk**: Near Middle Harbour; check flood maps.
   - **Bushfire Risk**: Leafy area; BAL-29+ possible, requiring fire-resistant design.
   - **Heritage Constraints**: No HCA; confirm with council.
   - **Access/Driveways**: Circular driveway exists; verify 15 m frontage post-subdivision.
   - **Utility Connections**: Existing house suggests nearby services; confirm capacity.
   - **Shadow Impacts**: 12 m height; ensure 2-3 hours sunlight for neighbors.
   - **Noise/Traffic**: Quiet street, but Warringah Road proximity may need buffering.
   - **Contamination**: Residential history; low risk, test near waterfront.
   - **Overland Flow Paths**: Waterfront runoff likely; design drainage.
   - **Privacy Impacts**: 3 m setbacks feasible; orient windows appropriately.
   - **Easements/Covenants**: Check title post-subdivision; waterfront may have easements.
   - **Site Orientation**: North-facing potential; optimize solar gain.
   - **Geotechnical Hazards**: Slopes may pose landslide risk; geotech report needed.
